# phone automation instagram-warmup
...
| `--browse-video <n>` | Number of videos to view, 1-100 |
...
```bash
geelark-cli phone automation instagram-warmup --id "557536075321468390" --schedule-at 1741846843 --browse-video 10
```
