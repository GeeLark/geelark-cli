# phone automation instagram-login
...
```bash
geelark-cli phone automation instagram-login --id "557536075321468390" --schedule-at 1741846843 --account "test@gmail.com" --password "123456"
```
