# phone automation threads-image
...
```bash
geelark-cli phone automation threads-image --id "557536075321468390" --schedule-at 1741846843 --title "title" --images "https://material.geelark.com/a.jpg"
```
