# phone automation facebook-login
...
```bash
geelark-cli phone automation facebook-login --id "557536075321468390" --schedule-at 1741846843 --email "test@gmail.com" --password "123456"
```
