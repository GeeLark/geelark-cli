# phone automation facebook-message
...
| `--content <text>` | Message content, max 20000 chars (required) |
...
```bash
geelark-cli phone automation facebook-message --id "557536075321468390" --schedule-at 1741846843 --usernames "user1" --content "Hello!"
```
