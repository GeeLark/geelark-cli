# phone automation tiktok-star

TikTok random star (like). Supports standard and Asia regions.
...
```bash
geelark-cli phone automation tiktok-star --id "557536075321468390" --schedule-at 1741846843 --like-probability 50
```
