# phone automation tiktok-message

Send private message on TikTok. Supports standard and Asia regions.
...
```bash
geelark-cli phone automation tiktok-message --id "557536075321468390" --schedule-at 1741846843 --usernames "user1" --content "Hello!"
```
