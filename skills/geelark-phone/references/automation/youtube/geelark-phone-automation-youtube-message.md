# phone automation youtube-message

Send private message on YouTube.
...
```bash
geelark-cli phone automation youtube-message --id "557536075321468390" --schedule-at 1741846843 --usernames "user1" --content "Hello!"
```
