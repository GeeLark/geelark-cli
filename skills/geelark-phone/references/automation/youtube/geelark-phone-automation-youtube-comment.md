# phone automation youtube-comment

YouTube AI random comment.
...
```bash
geelark-cli phone automation youtube-comment --id "557536075321468390" --schedule-at 1741846843 --use-ai 2 --comment "Great video!"
```
