# browser automation task-restart

Retry a browser automation task. Can retry if the task failed or was cancelled.
...
```bash
# Retry a task
geelark-cli browser automation task-restart --task-id "497652752864775437"
```
