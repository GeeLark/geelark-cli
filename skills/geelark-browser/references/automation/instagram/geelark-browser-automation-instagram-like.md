# browser automation instagram-like

Create an Instagram automation task to browse and like posts in the feed.
...
```bash
# Like Instagram feed posts
geelark-cli browser automation instagram-like --eid "557536075321468390" --schedule-at 1741846843
