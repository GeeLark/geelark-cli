# browser automation facebook-post

Create a Facebook automation task to post a status with specified content.
...
| `--content <text>` | Status content (required) |
...
geelark-cli browser automation facebook-post --eid "557536075321468390" --schedule-at 1741846843 --content "hello"
